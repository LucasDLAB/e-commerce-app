...
RSpec.describe Admin, type: :model do
  describe '#valid' do
    it 'falso se possuir campos vazios' do
      admin = described_class.new(email: 'lucas@sistemadefrete.com', password: 'password', name: '')
    ...
    it 'falso se dominio de email diferente de @sistemadefrete' do
      admin = described_class.new(email: 'lucas@banana.com', password: 'password', name: 'Lucas')
    ...
    it 'email deve ser único' do
      admin = described_class.create(email: 'lucas@sistemadefrete.com', password: 'password', name: 'Lucas')
      second_admin = described_class.new(email: 'lucas@sistemadefrete.com', password: 'codigo', name: 'Ana')
