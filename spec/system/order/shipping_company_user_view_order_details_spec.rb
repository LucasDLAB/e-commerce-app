...
describe "Usuário da Transportadora acessa a página de pedidos" do
	it "visualiza pedidos pendentes" do
		shipping_company = create(:shipping_company, corporate_name: 'Ligeirinho', email_domain: '@ligeiro.com' , distance:100)
		...
		transport_vehicle = TransportVehicle.create!(brand: "Mercedes",year_manufacture: 2017,payload: 9000,
											 ...
											 height:12,length:33,width:43, shipping_company_id:shipping_company.id,status:0)
		...
		EstimatedDate.create!(min_distance:10 , max_distance:5100, business_day: 3,shipping_company_id: shipping_company.id)
	...
	it "com pedidos pendentes" do
		create(:shipping_company, corporate_name: 'Ligeirinho', brand_name: 'Ligeirinho LTDA', email_domain: '@ligeiro.com' , distance:100)
		User.create!(email:"lucas@ligeiro.com",password:"password",name:"Lucas")
		transport_vehicle = TransportVehicle.create!(brand: "Mercedes",year_manufacture: 2017,payload: 9000,
											 identification_plate:"AAAA000",vehicle_model:"Atego",
